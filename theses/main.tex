...
\input{src/desky.tex}
\clearpage
\includepdf[trim=0mm 0mm 0mm 0mm, angle=0.0]{src/imgs/zadani1.pdf}
\includepdf[trim=0mm 0mm 0mm 0mm, angle=0.0]{src/imgs/zadani2.pdf}
\newpage
\input{src/prohlaseni.tex}
\newpage
\input{src/abstrakt.tex}
\newpage
\tableofcontents
...
\addcontentsline{toc}{section}{Zdroje a použitá literatura}
\newpage
\listoffigures
