...
% TODO: zmínit, že součástí zpracování řeči je ASR, které ale já přímo neřeším a tak dále budu pracovat rovnou s textem

% TODO: přidat zmínku o tom, že referenční popis stačí jeden pro jeden obrázek (1 reference pro více testovacích popisů)
%       ale také, že může být víc referenčních popisů k jednomu obrázku, podle toho, co se zrovna chce hodnotit
