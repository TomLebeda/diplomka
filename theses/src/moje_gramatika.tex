...
\todo{můžu takhle použít anglické názvy? přijdou mi lepší než české \enquote{hladový} (greedy), \enquote{líný} (lazy) nebo \enquote{důsledný} (thorough) }
...
\todo{vyměnit za poctivý listing s celou gramatikou?}
\begin{center}
...
\todo{je \enquote{nejméněkrát} česky správně?}
...
\end{itemize}
\todo{zmínit že to je obdoba prohledávání do šířky/hloubky?}
...
\todo{zmínit, že to je \enquote{false positive} typ chyby? Případně psát typy chyb pak do teorie?}
