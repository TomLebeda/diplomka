...
\begin{figure}[ht!]
	\centering
	\begin{tikzpicture}
		\node[draw] at (-5.5, 1) {\includegraphics[scale=0.4]{imgs/dog_squirrel_tree_mushroom.pdf}};
		...
		\node[draw, ellipse, minimum width=2cm, minimum height=1cm] (mush) at (6,3) {\texttt{houba}};
...
% TODO: příklad s kompletním popisem atributy + hierarchie + triplety?
