...
Příkladem jednoduchého obrázku s několika vyznačenými objekty může být ilustrace zobrazená na Obrázku~\ref{fig:object_image}.
\begin{figure}[H]
	\centering
	\def\dist{1pt}
	\begin{tikzpicture}[inner sep=0pt]
		\node[draw, inner sep=3pt] at (0, 0) {\includegraphics[scale=0.35]{imgs/dog_squirrel_tree_mushroom.pdf}};
